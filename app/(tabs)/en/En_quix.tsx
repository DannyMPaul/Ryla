...
const questions: Record<string, QuizQuestion[]> = {
  beginner: [
    { 
      question: "Yesterday, we ................ an interesting movie.", 
      options: ["watch", "watched", "watching", "Don't Know"], 
      answer: "watched",
      context: "Past tense usage" 
    },
    { 
      question: "Translate into Spanish: Hello.", 
      options: ["Adiós", "Hola", "Por favor", "Don't Know"], 
      answer: "Hola" 
    },
    { 
      question: "What does 'thank you' mean in Spanish?", 
      options: ["Gracias", "Sí", "Adiós", "Don't Know"], 
      answer: "Gracias" 
    },
    { 
      question: "Choose the correct article for 'apple':", 
      options: ["A", "An", "The", "Don't Know"], 
      answer: "An" 
    },
    { 
      question: "Which is an English color?", 
      options: ["Red", "Book", "Door", "Don't Know"], 
      answer: "Red" 
    },
    { 
      question: "I like ................... chocolate.", 
      options: ["a", "an", "the", "Don't Know"], 
      answer: "the" 
    },
  ],
  intermediate: [
    { 
      question: "I really like ................ student. He is very friendly.", 
      options: ["this", "these", "that", "Don't Know"], 
      answer: "that" 
    },
    { 
      question: "We ................ to the cinema tomorrow.", 
      options: ["are going", "going", "goes", "Don't Know"], 
      answer: "are going" 
    },
    { 
      question: "Translate: I would like a coffee, please.", 
      options: ["Quiero un café, por favor.", "Me gustaría un café, por favor.", "Estoy bebiendo un café, por favor.", "Don't Know"], 
      answer: "Me gustaría un café, por favor." 
    },
    { 
      question: "She speaks ................ her teacher.", 
      options: ["to", "with", "about", "Don't Know"], 
      answer: "to" 
    },
    { 
      question: "Which sentence is correct?", 
      options: ["She has a black cat.", "She have a black cat.", "She has a black cats.", "Don't Know"], 
      answer: "She has a black cat." 
    },
  ],
  hard: [
    { 
      question: "Ella es más inteligente que su hermano.", 
      options: ["She is smarter than her brother.", 
               "She is less intelligent than her brother.", 
               "She is as intelligent as her brother.",
               "Don't Know"], 
      answer: "She is smarter than her brother." 
    },
    { 
      question: "What does 'to cook' mean in Spanish?", 
      options: ["Comer en la cocina", "Cocinar", "Limpiar la cocina", "Don't Know"], 
      answer: "Cocinar" 
    },
    { 
      question: "Choose the correct form: If I had money, I ................ a new car.", 
      options: ["buy", "will buy", "would buy", "Don't Know"], 
      answer: "would buy" 
    },
    { 
      question: "Identify the past participle: Write -> ................", 
      options: ["Writed", "Written", "Writing", "Don't Know"], 
      answer: "Written" 
    },
  ],
};
