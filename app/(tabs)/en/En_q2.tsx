...
const EnglishQuizScreen = () => {
  ...
  const questions: QuizQuestion[] = [
    {
      id: "1",
      question: 'Which one means "the boy" in Spanish?',
      options: [
        {
          id: "1",
          label: "mujer",
        ...
        },
        {
          id: "3",
          label: "hombre",
          image: require("../../../assets/images/roadMapImgs/man.jpg"),
          isCorrect: false,
        },
      ],
    },
    {
      id: "2",
      question: 'Which one means "the girl" in Spanish?',
      options: [
        {
          id: "1",
          label: "mujer",
        ...
        },
        {
          id: "2",
          label: "chica",
          image: require("../../../assets/images/roadMapImgs/girl.jpg"),
          isCorrect: true,
        },
        {
          id: "3",
    ...
    {
      id: "3",
      question: 'Which one means "the cat" in Spanish?',
      options: [
        {
          id: "1",
          label: "perro",
    ...
    {
      id: "4",
      question: 'Which one means "the apple" in Spanish?',
      options: [
        {
          id: "1",
          label: "plátano",
    ...
    {
      id: "5",
      question: 'Which one means "the dog" in Spanish?',
      options: [
        {
          id: "1",
          label: "conejo",
        ...
        },
        {
          id: "3",
          label: "pez",
          image: require("../../../assets/images/roadMapImgs/fish.jpg"),
          isCorrect: false,
        },
      ],
    },
      ...
      if (selectedAnswer && selectedAnswer.isCorrect) {
        ...
        await update(userRef, {
          [`learnedWords/${new Date().getTime()}`]: {
            ...
            section: "English Quiz 1",
            context: "Basic nouns - Articles",
          },
          [`quizResponses/english_q${currentQuestion.id}/completed`]: true,
          [`quizResponses/english_q${currentQuestion.id}/completedAt`]:
        ...
        await update(userRef, {
          [`quizResponses/english_q${currentQuestion.id}/attempts`]:
            (userData?.quizResponses?.[`english_q${currentQuestion.id}`]
              ?.attempts || 0) + 1,
        ...
        if (hearts <= 1) {
          await update(userRef, {
            hearts: 5,
            [`quizResponses/english_q${currentQuestion.id}/failed`]: true,
          });
