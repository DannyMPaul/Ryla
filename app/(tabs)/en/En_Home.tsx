...
const HomeScreen: React.FC = () => {
  ...
  const renderPathNode = (
    ...
    const handlePress = () => {
      ...
      switch (level) {
        case 1:
          if (!completedQuestions.q1) router.replace("./Eng/q1");
          else if (!completedQuestions.q2) router.replace("./Eng/q2");
          break;
        case 2:
          if (!completedQuestions.star2q1) router.replace("./Eng/star2q1");
          else if (!completedQuestions.star2q2) router.replace("./Eng/star2q2");
          break;
        default:
          onPress();
      }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => router.replace("../En/En_Home1")}
      >
        ...
        <View style={styles.content}>
          ...
          <View style={styles.learningPath}>
            <TouchableOpacity
              ...
              onPress={() => router.replace("/Eng/q1" as any)}
            >
              <Text style={styles.startButtonText}>START</Text>
            </TouchableOpacity>

            {renderPathNode(1, "star", () => router.replace("/Eng/q1" as any))}
            ...
            >
              <TouchableOpacity
                onPress={() => router.replace("/Eng/star2q1" as any)}
                disabled={
            ...
            {renderPathNode(3, "star", () => router.replace(`/Eng/q3` as any))}
            <View style={styles.pathLine} />
