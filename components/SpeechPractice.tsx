...
const SpeechPractice: React.FC<SpeechPracticeProps> = ({
  ...
  const analyzePronunciation = async (audioUri: string) => {
    ...
    try {
      ...
      const overallScore = Math.floor(
        (analysis.clarity + analysis.pace + analysis.volume + analysis.pitch) /
          4
      );
      ...
      if (
        ...
        overallScore > currentWord.pronunciationScore
      ) {
  ...
  const translateAllContent = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Translation Error",
        "Failed to translate some content. Please try again."
      );
    } finally {
        ...
        {showFeedback && feedback && (
          <View style={styles.feedbackModal}>
            <View style={styles.feedbackContent}>
              <Text style={styles.scoreTitle}>Pronunciation Analysis</Text>
              <Text
                style={[
                  styles.scoreValue,
                  feedback.score >= 90
                  ...
                  <View style={styles.metricContainer}>
                    ...
                    <View style={styles.metricBar}>
                      <View
                        style={[
                          styles.metricFill,
                          { width: `${voiceAnalysis.volume}%` },
                        ]}
                      />
                    </View>
                    <Text style={styles.metricValue}>
                      {voiceAnalysis.volume}%
                    </Text>
                  </View>
                  <View style={styles.metricContainer}>
